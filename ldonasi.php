<nav class="navbar navbar-light bg-light mb-3">
  <a class="navbar-brand" href="#">LAPORAN DONASI</a>
</nav>
...
<script type="text/javascript">
	function print(e){
		if(e=='tgl'){
			...
			if(tgl){
				console.log('ok');
				window.location="lap-donasi.php?tanggal="+tgl
			}else{
			...
			if(bln && thn){
				console.log('ok');
				window.location="lap-donasi.php?bulan="+bln+"&tahun="+thn
			}else{
			...
			if(th){
				console.log('ok');
				window.location="lap-donasi.php?tahun="+th
			}else{
